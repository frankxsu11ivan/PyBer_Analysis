...
## Overview of Project
#the overview of the project is to understand two different ways of plotting. Plotting through pandas and through matplotlib.
the story follows Python Ubers == pyber through and analysis of indecies, columns and values. In these data frames the date is organized in dates as 'indexes',
...
with the how "left" some some uraban data was not called. In the 'Urban' df ithe data table was used for the results.
...
there may be a profit center for suburban rides per type, however the rural share of riders should not be a profir center focus. 
